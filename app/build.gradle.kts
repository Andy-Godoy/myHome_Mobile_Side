...
dependencies {
    ...
    implementation ("pl.droidsonroids.gif:android-gif-drawable:1.2.19") //Libreria para el uso de gifs
    ...
    implementation ("com.google.code.gson:gson:2.8.9") //Libreria para el uso de Gson
}
