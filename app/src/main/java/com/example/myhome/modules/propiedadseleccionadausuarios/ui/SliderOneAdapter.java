...
import com.example.myhome.databinding.SlideritemPropiedadSeleccionadaUsuarios2Binding
...
class SliderOneAdapter(
  ...
  override fun bindView(
    ...
    if (binding is SlideritemPropiedadSeleccionadaUsuarios2Binding) {
  ...
  override fun inflateView(
    ...
    val itemBinding =  SlideritemPropiedadSeleccionadaUsuarios2Binding.inflate(
