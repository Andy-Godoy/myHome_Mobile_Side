package com.example.myhome.modules.contactaryturnoone.`data`.model

import com.example.myhome.R
import com.example.myhome.appcomponents.di.MyApp
import kotlin.String

data class ContactarYTurnoOneModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtLanguageTwo: String? = MyApp.getInstance().resources.getString(R.string.lbl_mensaje)
  ,
  /**
   * TODO Replace with dynamic value
   */
