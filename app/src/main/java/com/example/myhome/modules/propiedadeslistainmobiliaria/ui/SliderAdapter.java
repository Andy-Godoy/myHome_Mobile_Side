...
import com.example.myhome.databinding.SlideritemPropiedadesListaInmobiliaria1Binding
...
class SliderAdapter(
  ...
  override fun bindView(
    ...
    if (binding is SlideritemPropiedadesListaInmobiliaria1Binding) {
  ...
  override fun inflateView(
    ...
    val itemBinding =  SlideritemPropiedadesListaInmobiliaria1Binding.inflate(
